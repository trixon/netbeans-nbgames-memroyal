...
public class MemroyalNewGamePanel extends NewGamePanel {
    ...
    public MemroyalNewGamePanel() {
        initComponents();
        Object[] players = PlayerManager.getInstance().getListModel().toArray();
        init();
    }
...
//        Options.INSTANCE.setPlayer(name);
    ...
    private void init() {
        LinkedList<String> variationNames = new LinkedList<>();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(levelLabel, DictNbg.LEVEL.toString());
        ...
        org.openide.awt.Mnemonics.setLocalizedText(variationLabel, DictNbg.GAME_TYPE.toString());
